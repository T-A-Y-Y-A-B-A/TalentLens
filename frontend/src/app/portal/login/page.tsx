...
export default function CandidateLoginPage() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-white -mt-4">
      {/* Left side: Form */}
      <div className="flex flex-1 flex-col px-4 py-12 sm:px-6 lg:flex-none lg:w-1/2 lg:px-20 xl:px-24 justify-center">
        <div className="mx-auto w-full max-w-sm lg:max-w-md relative flex flex-col justify-center min-h-[500px]">
          ...
          <div className="mt-20 w-full">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-zinc-900 tracking-tight">Candidate Sign In</h1>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <a href="/api/v1/candidate-portal/oauth/google/login" className="block w-full">
      ...
      <AuthBrandPanel 
        headline="Find where your skills truly fit." 
        subtext="Join thousands of candidates getting matched to roles based on what they can actually do — not just keywords on a resume." 
      />
    </div>
  );
}
